    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('to_visit', models.ForeignKey(related_name=b'places_to_visit', to='wetravel.Place', null=True)),
                ('user', models.OneToOneField(to=settings.AUTH_USER_MODEL)),
                ('visited', models.ManyToManyField(related_name=b'places_visited', null=True, to='wetravel.Place')),
            ],
            options={
            },
            bases=(models.Model,),
